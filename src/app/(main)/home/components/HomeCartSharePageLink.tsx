...
export const HomeCartSharePageLink = () => {
  ...
  useEffect(() => {
    ...
    const accessToken ="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3NTQ0ODY0MDgsInBheWxvYWQiOnsiZW1haWwiOiJ0ZXN0NUBnbWFpbC5jb20iLCJ1c2VySWQiOjI0fSwiaWF0IjoxNzU0NDgyODA4fQ.kg9ZN9XWQe7a1JSVSHRglxLJo4qebm1w9YkviUbJfv8"
        ...
        <div className="flex gap-8">
          <div className="flex items-center gap-2">
            <div className="grid flex-1 gap-2">
              ...
              <Input
                id="link"
                value={`https://yourdomain.com/user/${user?.profileCurrent?.user?.id || ""}`}
                readOnly
              />
            </div>
          </div>
